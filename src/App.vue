        ...
        <div class="collapse navbar-collapse" id="ms-navbar">
          <ul class="navbar-nav">
                ...
                <li class="ms-tab-menu">
                  ...
                  <div class="tab-content ms-tab-menu-right">
                    ...
                    <div class="tab-pane" id="tab-revolution" role="tabpanel">
                      <ul class="ms-tab-menu-right-container">
                        <li>
                          <a class="with-badge" href="home-revolution.html">
                            Home Revolution Devices
                            <span class="badge badge-success pull-right">1.3</span>
                          </a>
                        </li>
                        <li>
                          <a class="with-badge" href="home-revolution2.html">
                            Home Revolution App
                            <span class="badge badge-success pull-right">1.3</span>
                          </a>
                        </li>
                        <li>
                          <a class="with-badge" href="home-revolution3.html">
                            Home Revolution Video
                            <span class="badge badge-success pull-right">1.3</span>
                          </a>
                        </li>
                        <li>
                          <a class="with-badge" href="home-revolution4.html">
                            Home Revolution Idea
                            <span class="badge badge-success pull-right">1.3</span>
                          </a>
                        </li>
                      </ul>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="dropdown-submenu">
                  ...
                  <ul class="dropdown-menu dropdown-menu-left">
                    <li>
                      <a class="dropdown-item with-badge" href="page-email.html">
                        Email Template 1
                        <span class="badge badge-success text-right">1.2</span>
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item with-badge" href="page-email2.html">
                        Email Template 2
                        <span class="badge badge-success text-right">1.2</span>
                      </a>
                    </li>
                ...
                <li><a class="dropdown-item dropdown-link" href="page-all.html">All Pages</a></li>
              </ul>
            </li>
                          ...
                          <li>
                            <a class="withripple" href="component-forms.html">
                              ...
                              <span class="badge badge-info pull-right">
                                <i class="zmdi zmdi-long-arrow-up no-mr"></i>
                                1.5
                              </span>
                            </a>
                          </li>
                        ...
                        <ul class="megamenu-block-list">
                          ...
                          <li>
                            <a class="withripple" href="component-breadcrumb.html">
                              <i class="zmdi zmdi-label-alt-outline"></i>
                              Breadcrumb
              ...
              <ul class="dropdown-menu">
                ...
                <li>
                  <a class="dropdown-item" href="blog-full.html">
                    <i class="zmdi zmdi zmdi-view-stream"></i>
                    Blog Full Page 1
                  </a>
                </li>
                <li>
            ...
            <li class="nav-item dropdown">
              <a
                href="#"
                class="nav-link dropdown-toggle animated fadeIn animation-delay-9"
                data-toggle="dropdown"
                data-hover="dropdown"
                role="button"
                aria-haspopup="true"
